...
function RecordAnsSection({ mockinterviewQues,ActiveQuestion,interviewData}) {
  ...
  return (
      <div className='flex items-center justify-center flex-col'>
         <div className='flex flex-col mt-20 justify-center items-center bg-secondary rounded-lg p-5 relative'>
